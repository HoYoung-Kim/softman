...
/**
 * 카테고리 코드를 가져오는 비동기 클래스 - 기타
 */

public class AsyncTaskOthers extends AsyncTask<String, Void, String> {

    private static final String TAG = AsyncTaskOthers.class.getSimpleName();
...
//    private TaskCategoryCompleted mCallback;
    ...
    private FROthersFragment frOthersFragment;

    private Context mContext;

    public AsyncTaskOthers(FROthersFragment frOthersFragment, View view) {
        this.frOthersFragment = frOthersFragment;
        this.view = view;
    }
    ...
    protected void onPostExecute(String s) {
        ...
        if(frOthersFragment != null && categoryInfos != null){
            frOthersFragment.onTaskComplete(categoryInfos, apiResultData, view);
        }
    }
}
