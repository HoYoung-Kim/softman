...
/**
 * 카테고리 코드를 가져오는 비동기 클래스 - 외국
 */

public class AsyncTaskForeignCountry extends AsyncTask<String, Void, String> {

    private static final String TAG = AsyncTaskForeignCountry.class.getSimpleName();
...
//    private TaskCategoryCompleted mCallback;
    ...
    private FRForeignCountryFragment frForeignCountryFragment;

    private Context mContext;

    public AsyncTaskForeignCountry(FRForeignCountryFragment frForeignCountryFragment, View view) {
        this.frForeignCountryFragment = frForeignCountryFragment;
        this.view = view;
    }
    ...
    protected void onPostExecute(String s) {
        ...
        if(frForeignCountryFragment != null && categoryInfos != null){
            frForeignCountryFragment.onTaskComplete(categoryInfos, apiResultData, view);
        }
    }
}
