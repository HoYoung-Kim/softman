...
/**
 * 카테고리 코드를 가져오는 비동기 클래스 - 국립2
 */

public class AsyncTaskNational2 extends AsyncTask<String, Void, String> {

    private static final String TAG = AsyncTaskNational2.class.getSimpleName();
...
//    private TaskCategoryCompleted mCallback;
    ...
    private FRNational2Fragment frNational2Fragment;

    private Context mContext;

    public AsyncTaskNational2(FRNational2Fragment frNational2Fragment, View view) {
        this.frNational2Fragment = frNational2Fragment;
        this.view = view;
    }
...
//        if(frNational2Fragment != null && categoryInfos != null){
//            frNational2Fragment.onTaskComplete(categoryInfos, apiResultData, view);
//        }
    }
}
