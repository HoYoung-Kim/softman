...
/**
 * 외국 fragment.
 * category1_code = PS01007
 */
public class FRForeignCountryFragment extends Fragment  implements RowItemClickListener{

    private static final String TAG = FRForeignCountryFragment.class.getSimpleName();
    ...
    public FRForeignCountryFragment() {
    ...
    private void addDataToList(View rootView) {
        ...
        if (pageNo == 1){
            new AsyncTaskForeignCountry(this, rootView)
                    .execute(getActivity().getString(R.string.category7_code), Integer.toString(pageNo++));
