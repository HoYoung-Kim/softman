...
/**
 * 카테고리 코드를 가져오는 비동기 클래스 - 학교
 */

public class AsyncTaskUniversity extends AsyncTask<String, Void, String> {

    private static final String TAG = AsyncTaskUniversity.class.getSimpleName();
...
//    private TaskCategoryCompleted mCallback;
    ...
    private FRUniversityFragment frUniversityFragment;

    private Context mContext;

    public AsyncTaskUniversity(FRUniversityFragment frUniversityFragment, View view) {
        this.frUniversityFragment = frUniversityFragment;
        this.view = view;
    }
    ...
    protected void onPostExecute(String s) {
        ...
        if(frUniversityFragment != null && categoryInfos != null){
            frUniversityFragment.onTaskComplete(categoryInfos, apiResultData, view);
        }
    }
}
