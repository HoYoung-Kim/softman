...
public class ItemActivity extends MyBaseActivity implements TaskItemCompleted, RowItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState)  {
        ...
        toolbarText.setText(category_name);
    ...
    private void addDataToList() {
        if (pageNo == 1){
            new AsyncTaskItemList(this).execute(category_code, Integer.toString(pageNo++));
    ...
    //
    // return value from AsyncTask(AsyncTaskItemList)....
    //
    @Override
