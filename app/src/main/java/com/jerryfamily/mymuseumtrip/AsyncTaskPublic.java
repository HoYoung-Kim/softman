...
/**
 * 카테고리 코드를 가져오는 비동기 클래스 - 공립
 */

public class AsyncTaskPublic extends AsyncTask<String, Void, String> {

    private static final String TAG = AsyncTaskPublic.class.getSimpleName();
...
//    private TaskCategoryCompleted mCallback;
    ...
    private FRPublicFragment frPublicFragment;

    private Context mContext;

    public AsyncTaskPublic(FRPublicFragment frPublicFragment, View view) {
        this.frPublicFragment = frPublicFragment;
        this.view = view;
    }
    ...
    protected void onPostExecute(String s) {
        ...
        if(frPublicFragment != null && categoryInfos != null){
            frPublicFragment.onTaskComplete(categoryInfos, apiResultData, view);
        }
    }
}
