...
/**
 * 국립2 fragment.
 * category1_code = PS01002
 */
public class FRNational2Fragment extends Fragment implements RowItemClickListener {

    private static final String TAG = FRNational2Fragment.class.getSimpleName();
    ...
    private void addDataToList() {
        ...
        if (pageNo == 1){
            new requestURLAsyncTask()
                    .execute(getActivity().getString(R.string.category2_code), Integer.toString(pageNo++));
