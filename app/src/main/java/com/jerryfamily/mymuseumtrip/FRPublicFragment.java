...
/**
 * 공립 fragment.
 * category1_code = PS01003
 */
public class FRPublicFragment extends Fragment implements RowItemClickListener{

    private static final String TAG = FRPublicFragment.class.getSimpleName();
    ...
    private void addDataToList(View rootView) {
        ...
        if (pageNo == 1){
            new AsyncTaskPublic(this, rootView)
                    .execute(getActivity().getString(R.string.category3_code), Integer.toString(pageNo++));
