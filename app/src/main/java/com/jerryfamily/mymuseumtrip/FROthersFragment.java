...
/**
 * 기타 fragment.
 * category1_code = PS01006
 */
public class FROthersFragment extends Fragment implements RowItemClickListener{

    private static final String TAG = FROthersFragment.class.getSimpleName();
    ...
    private void addDataToList(View rootView) {
        ...
        if (pageNo == 1){
            new AsyncTaskOthers(this, rootView)
                    .execute(getActivity().getString(R.string.category6_code), Integer.toString(pageNo++));
