...
/**
 * 검색 리스트를 가져오는 비동기 클래스
 */

public class AsyncTaskSearchList extends AsyncTask<String, Void, String> {

    private static final String TAG = AsyncTaskSearchList.class.getSimpleName();
    ...
    public AsyncTaskSearchList(Context mContext) {
    ...
    protected String doInBackground(String... strings) {
        ...
        String searchlist_url = String.format(ConstantManager.SEARCH_LIST_URL,
