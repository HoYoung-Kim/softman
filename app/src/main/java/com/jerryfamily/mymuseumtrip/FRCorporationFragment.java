...
/**
 * 법인/사립 fragment.
 * category1_code = PS01004
 */
public class FRCorporationFragment extends Fragment implements RowItemClickListener{

    private static final String TAG = FRCorporationFragment.class.getSimpleName();
    ...
    private void addDataToList(View rootView) {
        ...
        if (pageNo == 1){
            new AsyncTaskCorporation(this, rootView)
                    .execute(getActivity().getString(R.string.category4_code), Integer.toString(pageNo++));
